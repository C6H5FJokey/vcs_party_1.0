#vp_core:constructors/srtucture_builder/init
# 初始化srtucture_builder模块
...
# 注册本模块
data modify storage module_control:io input set value {prefix:"vp_core:constructors/srtucture_builder/",namespace:"vp_core"}
function module_control:data/_reg
scoreboard players operation #vp_core:constructors/srtucture_builder/ module_id = res int
...
function vp_core:constructors/srtucture_builder/_class