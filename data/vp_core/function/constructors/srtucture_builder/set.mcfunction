#vp_core:constructors/srtucture_builder/set
# vp_core:constructors/srtucture_builder/_new调用
...
# 获取模块编号
scoreboard players operation @s module_id = #vp_core:constructors/srtucture_builder/ module_id